...
public class FilamentHelper {
    private static final String LOG_TAG = "FilamentHelper";
    ...
    public interface RendererCallback {
        ...
        // NOTE: this could be called from FilamentHelper's constructor.
    ...
    private class SurfaceViewHandler implements RenderSurface {
        ...
        public SurfaceViewHandler(SurfaceView surface) {
    ...
    private class TextureViewHandler implements RenderSurface {
        ...
        public TextureViewHandler(TextureView surface) { mTextureView = surface; }
    ...
    /**
     *  Creates a FilamentHelper which will help manage the EGL context
     *  and EGL surfaces. FilamentHelper handles SurfaceView and TextureView.
     *
     *  When this call returns, OpenGL ES is ready to use.
     */
    public FilamentHelper() {
        this(ContextErrorPolicy.CHECK);
    }

    public FilamentHelper(ContextErrorPolicy policy) {
        // TODO: do something with policy
    }

    public FilamentHelper(int sampleCount, RendererCallback renderCallback) {
        this();
    ...
    /**
     * Associate FilamentHelper with a SurfaceView.
     *
    ...
    /**
     * Associate FilamentHelper with a TextureView.
     *
